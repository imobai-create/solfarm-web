...
const T = {
  ...
  en: {
    ...
    pricing: {
      ...
      plans: [
        { name: "Free", price: "R$ 0", period: "/forever", highlight: false, features: ["1 registered field","Basic NDVI diagnosis","30-day history","Marketplace (view only)"] },
        { name: "Campo", price: "R$ 49", period: "/mo", highlight: true, features: ["Up to 5 fields","NDVI + NDRE + NDWI","VRA fertilization plan","Marketplace purchases","Automatic alerts","12-month history"] },
        { name: "Fazenda", price: "R$ 149", period: "/mo", highlight: false, features: ["Unlimited fields","Advanced AI","Agricultural score + credit","API access","PDF reports","Dedicated support"] },
      ],
